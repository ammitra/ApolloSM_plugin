...
int main(int argc, char** argv) { 
  ...
  cli_options.add_options()
    ...
    ("cm_powerup,P",         po::bool_switch()->default_value(false),      "Powerup CM")
    ("cm_powerup_time,t",    po::value<int>()->implicit_value(0),          "Powerup time in seconds")
    ("sensorsThroughZynq,s", po::bool_switch()->default_value(false),      "Read sensors through the Zynq"); // This means: by default, read the sensors through the zynq
  ...
  cfg_options.add_options()
    ...
    ("cm_powerup",         po::bool_switch()->default_value(false),        "Powerup CM")
    ("cm_powerup_time",    po::value<int>(),         "Powerup time in seconds")
    ("sensorsThroughZynq", po::bool_switch()->default_value(false),        "Read sensors through the Zynq"); // This means: by default, read the sensors through the zynq
